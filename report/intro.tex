...
sometimes include temporal aspects such as ``always'' or
...
parametric protocols. However, they are not particularly well suited to
...
developments in the MCMT framework \cite{AlbertiGP16} support
...
technology. The decision procedure for arithmetic is described in
