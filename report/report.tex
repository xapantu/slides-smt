...
with arrays. Both decision procedures are implemented as overlays to
...
%If the property \ref{distinct} holds and every interval of $S$ is
%finite, then:
...
%constraints}\label{algorithm-to-solve-arithmetic-counting-constraints}
